...
def changedir():
    os.chdir(r"C:\Users\30075167\OneDrive - New College Lanarkshire\Python Alan Mcgregor\Advanced Work\Files")
...
def main():
    ...
    global bgImage
    bgImage = PhotoImage(file=r'C:/Users/30075167/OneDrive - New College Lanarkshire/Python Alan Mcgregor/Advanced Work/Assets/bg.png')

    logoImage = PhotoImage(file=r'C:/Users/30075167/OneDrive - New College Lanarkshire/Python Alan Mcgregor/Advanced Work/Assets/smol.png')
